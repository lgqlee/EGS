...
fn.saveDB = function (callback, fields) {
    ...
    if (this._options['redis_only']) {
        return callback && callback(false, self)
    }
    if (!fields) {
        fields = _getDirtyFields.call(this);
        if (fields['|errors']) {
            return callback || callback(fields['|errors'], self)
        }
    }
    var sql_params = {
...
fn.saveRedis = function (callback, fields) {
    ...
    db_pool.redis.hmset(this['redis_key'], fields,
        function (err) {
            if (err) throw Error(err);
            if (!self._options['expire'] || this._is_new) {
                return callback && callback(false, self);
            }
...
fn.save = function (callback) {
    ...
    this.saveRedis(function () {
        self.saveDB(callback, fields);
    }, fields);
};
